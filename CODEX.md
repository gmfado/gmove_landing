# CODEX - Executor Principal do GMOVE Website

## Papel

Codex executa o site público do GMOVE: landing, editorial, SEO, assets, documentação e QA visual.

## Fonte de Verdade

Antes de mexer em conteúdo, design ou estrutura do site, ler nesta ordem:

1. `documents/00_START_HERE.md`
2. `documents/CODEX_HANDOFF.md`
...
- Usar `GMOVE` como marca pública, sem hífen.
- O site deve vender o app atual: treinador inteligente de musculação, não ficha digital.
...
Sempre que houver mudança visual:

- rodar um servidor estático local;
- validar desktop e mobile no navegador;
- checar console;
